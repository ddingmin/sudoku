...
import { decodeDuel, judge, verdictText } from "@/lib/duel";
        ...
        <Flood color={T.primary} deep={T.strong}>
          <div style={card}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: 8 }}>
              <span style={{ fontSize: 20, fontWeight: 700, letterSpacing: 10, color: C.inkFaint }}>친구 기록</span>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 14 }}>
              ...
              <div style={{ flex: 2.2, display: "flex", alignItems: "center", justifyContent: "center", background: T.primary, border: `3px solid ${C.ink}`, borderRadius: 14 }}>
                <span style={{ fontSize: 26, fontWeight: 700, color: C.surface }}>같은 문제로 붙어볼래? →</span>
              </div>
            </div>
          </div>
        </Flood>
        ...
        <div style={card}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginTop: 24 }}>
            <span style={{ fontSize: 28, fontWeight: 700, color: C.ink }}>
              {verdictText(record.timeSec, opponent.timeSec, "답장 기록이", "도전장 기록이")} · 같은 문제 풀어보기 →
            </span>
          </div>
        </div>
      </Flood>
